...
Namespace SuperGridDemo
	<ToolboxItem(False)> _
	Public Class GridClipEditControl
		Inherits ClipControl
...
#End Region
        ...
        Public Sub New()
            ...
            AddHandler labelX1.DoubleClick, AddressOf ContentDoubleClick

            AddHandler btnPlay.Click, AddressOf BtnPlayClick
            AddHandler btnStop.Click, AddressOf BtnStopClick
        End Sub
...
#Region "BtnPlayClick"
        ...
        ''' <param name="e"></param>
        Protected Overridable Sub BtnPlayClick(ByVal sender As Object, ByVal e As EventArgs)
        End Sub
...
#Region "BtnStopClick"
        ...
        ''' <param name="sender"></param>
        ''' <param name="e"></param>
        Protected Overridable Sub BtnStopClick(ByVal sender As Object, ByVal e As EventArgs)
        End Sub
...
#Region "ContentDoubleClick"
        ...
        ''' <param name="sender"></param>
        ''' <param name="e"></param>
        Protected Overridable Sub ContentDoubleClick(ByVal sender As Object, ByVal e As EventArgs)
        End Sub
