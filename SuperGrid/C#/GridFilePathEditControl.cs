...
{
    [ToolboxItem(false)]
    public class GridFilePathEditControl : FilePathControl, IGridCellEditControl
    {
        ...
        /// GridClipEditControl
        ///</summary>
        public GridFilePathEditControl()
        {
            ...
            FilePathChanged += GridFilePathChanged;
        }

        #region GridFilePathChanged

        void GridFilePathChanged(object sender, FilePathChangedEventArgs e)
        {
        ...
        {
            // Modal – Edit operations will be performed as a modal, widowed
            // edit controlled via calls to BeginEdit, EndEdit, and CancelEdit.
        ...
        ///<summary>
        /// Called to inform the editor it needs to
        /// initialize the its context environment.
        ///</summary>
